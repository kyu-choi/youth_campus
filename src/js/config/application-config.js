...
window.CheongchunCampus.config.applicationForm = {
  ...
  privacyText:
    "수집 항목: 이름, 연락처, 카카오톡 ID, 학교, 학과, 거주지, 프로필 정보, 학생 인증 자료, 사진 등 신청서에 기입된 사항. 목적: 신청자 확인, 대학생 인증, 매칭 검토, 선정자 안내 및 행사 운영. 보유 기간: 행사 진행 후 3개월 이내 폐기.",
  submitLabel: "신청완료",
  successTitle: "신청서 작성이 완료되었습니다",
  successMessage:
    "최종 접수를 위해 청춘 캠퍼스 공식 카카오톡 채널로 아래 정보를 보내주세요.\n\n지역 / 이름 / 학교 / 신청유형\n예: 대구 / 홍길동 / 경북대 / 신규 신청완료\n\n카톡 채널: http://pf.kakao.com/_BxcVTX\n\n확인 후 빠른 시일 내로 연락드리겠습니다.",
  pages: [
    {
      eyebrow: "프로그램 선택",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label:
            "카카오톡 채널로 지역 / 이름 / 학교 / 신청유형을 보내야 최종 접수가 완료됨을 확인했습니다.",
          type: "checkbox",
          required: true,
        },
      ],
